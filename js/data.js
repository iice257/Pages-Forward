...
const baseBooks = [
  ...
  { id: 6, title: "Beloved", author: "Toni Morrison", subtitle: "A Ghost Story", description: "A haunting exploration of slavery's psychological legacy.", coverImage: "https://images.unsplash.com/photo-1476275466078-4007374efbbe?w=600&h=900&fit=crop", tags: { type: "Fiction", category: "Historical", niche: "African American Literature" }, popularity: { author: 0.95, book: 0.9 }, length: "Medium", status: "reserved", bestseller: true },
...
function generateBooksData() {
  ...
  for (let i = 0; i < 100; i++) {
    ...
    books.push({
      ...
      bestseller: isExtra ? (Math.random() > 0.95) : seed.bestseller,
